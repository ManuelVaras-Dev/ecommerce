            ...
            $dataJson = '{
				...
				foreach ($data as $key => $value) {
            		...
            		if($value->status_banner == 1){
	            		...
	            		$status_banner = "<input type='checkbox' data-size='mini' data-bootstrap-switch data-off-color='danger' data-on-color='success' checked='true' idItem='".base64_encode($value->id_banner)."' table='banners' column='banner'>";

	            	}else{

	            		$status_banner = "<input type='checkbox' data-size='mini' data-bootstrap-switch data-off-color='danger' data-on-color='success' idItem='".base64_encode($value->id_banner)."' table='banners' column='banner'>";
	            	}
					...
					$discount_banner = $value->discount_banner."% DE DSCTO.";
