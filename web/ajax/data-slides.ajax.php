            ...
            $dataJson = '{
				...
				foreach ($data as $key => $value) {
            		...
            		if($value->status_slide == 1){
	            		...
	            		$status_slide = "<input type='checkbox' data-size='mini' data-bootstrap-switch data-off-color='danger' data-on-color='success' checked='true' idItem='".base64_encode($value->id_slide)."' table='slides' column='slide'>";

	            	}else{

	            		$status_slide = "<input type='checkbox' data-size='mini' data-bootstrap-switch data-off-color='danger' data-on-color='success' idItem='".base64_encode($value->id_slide)."' table='slides' column='slide'>";
	            	}
