            ...
            $dataJson = '{
				...
				foreach ($data as $key => $value) {
            		...
            		if($value->status_product == 1){
	            		...
	            		$status_product = "<input type='checkbox' data-size='mini' data-bootstrap-switch data-off-color='danger' data-on-color='success' checked='true' idItem='".base64_encode($value->id_product)."' table='products' column='product'>";

	            	}else{

	            		$status_product = "<input type='checkbox' data-size='mini' data-bootstrap-switch data-off-color='danger' data-on-color='success' idItem='".base64_encode($value->id_product)."' table='products' column='product'>";
	            	}
