						  ...
						  "purchase_units": [
						    {
						      ...
						      "amount": {
						        "currency_code": "USD",
						        "value": '.round($totalCart/TemplateController::exchange("currency")).'
