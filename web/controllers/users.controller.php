...
class UsersController{
	...
	public function resetPassword(){
		...
		if(isset($_POST["resetPassword_User"])){
			...
			if(preg_match( '/^[.a-zA-Z0-9_]+([.][.a-zA-Z0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$/', $_POST["resetPassword_User"] )
			){
				...
				$url = "users?linkTo=email_user&equalTo=".$_POST["resetPassword_User"]."&select=id_user";
				$method = "GET";
				$fields = array();
				...
				if($user->status == 200){
					...
					if($updatePassword->status == 200){	
						...
						$email = $_POST["resetPassword_User"];
	...
	static public function socialConnect($type, $urlRedirect){
		...
		if($type == "facebook"){
			...
			$fb = new \Facebook\Facebook([
			  'app_id' => '1659995841482848',
			  'app_secret' => '2f0b16d350462d728a320deab05a1a6a',
