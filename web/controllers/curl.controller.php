...
class CurlController{
	...
	static public function paypal($url, $method, $fields){
		...
		$clientId = "AawmBWoBJo6mpp5SxvZCvBN9EixszHXQDc2YocXyQrjngRzbgFC4MQQezPE2MgeCc24tCe5pgmTDs7FV"; //TEST
		$secretClient = "EPT7rI9gRP6B52gHjVV3BVKKhwlc5JxXCLsDQxchMhU7sbXmodsOqDHorGkoCGb1mFw2TOwBr2kpOvQY"; //TEST
