...
class TemplateController{
	...
	static public function sendEmail($subject, $email, $title, $message, $link){
		...
		$mail->setFrom("noreply@ecommerce.com","Inversiones V&B Import SAC");
		...
		$mail->msgHTML('<div style="width:100%; background:#eee; position:relative; font-family:sans-serif; padding-top:40px; padding-bottom: 40px;">
			...
			<div style="position:relative; margin:auto; width:600px; background:white; padding:20px">
				...
				<center>
					...
					<i style="font-size: 13px; color:#999">Si no solicitó el envío de este correo, comuniquese con nosotros de inmediato: suport@ecommerce.com.pe</i>
