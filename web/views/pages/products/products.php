					...
					<a href="/<?php echo $value->url_product ?>">
						...
						<figure class="imgProduct">
							...
							?>
								...
								<img src="http://img.youtube.com/vi/<?php echo reset($lastarrayYT) ?>/maxresdefault.jpg" class="img-fluid bg-light">
					...
					<div class="clearfix">
						...
						<?php else: ?>
							...
							<h5 class="float-start text-uppercase text-muted">
								...
								<?php if ($value->offer_variant > 0): ?>
									<del class="small" style="color:#bbb">S/<?php echo $value->price_variant ?></del> S/<?php echo $value->offer_variant ?>
								<?php else: ?>
									S/<?php echo $value->price_variant ?>
								<?php endif ?>
						...
						<figure class="imgProduct">
							...
							<?php if ($value->type_variant == "gallery"): ?>
							    ...
							    ?>
									...
									<img src="http://img.youtube.com/vi/<?php echo reset($lastarrayYT) ?>/maxresdefault.jpg" class="img-fluid bg-light" style="width:150px">
