				...
				<?php if ($product->variants[0]->offer_variant > 0): ?>
					...
					<div class="blockPrice">
						...
						<h3 class="text-center">ANTES 
							<s>S/<?php echo number_format($product->variants[0]->price_variant,2)?></s>
						</h3>

						<h3 class="text-center">
							<span class="text-success pt-4">AHORA S/<?php echo number_format($product->variants[0]->offer_variant,2) ?></span>
							<span class="ml-2 px-2 p-1 small rounded-pill" 
							style="font-size: 16px; position:relative; top:-4px; border:2px solid #000 !important">
								AHORRA S/<?php echo number_format(($product->variants[0]->offer_variant-$product->variants[0]->price_variant),2) ?>			
							</span>
						</h3>
				...
				<?php else: ?>
					...
					<div class="blockPrice">
						...
						<h2 class="text-center">
							<span class="text-success pt-4">S/<?php echo number_format($product->variants[0]->price_variant,2) ?></span>
						</h2>
