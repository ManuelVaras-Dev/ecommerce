								...
								<div class="card-body">
									...
									<div class="form-group pb-3"> 
										...
										<select name="rol_admin" id="rol_admin" class="form-control" required>
											...
											<option value="administrador" <?php if (!empty($admin) && $admin->rol_admin == "administrador"): ?> selected <?php endif ?>>Administrador</option>
											<option value="contador" <?php if (!empty($admin) && $admin->rol_admin == "contador"): ?> selected <?php endif ?>>Contador</option>
											<option value="almacenero" <?php if (!empty($admin) && $admin->rol_admin == "almacenero"): ?> selected <?php endif ?>>Almacenero</option>
											<option value="asistente" <?php if (!empty($admin) && $admin->rol_admin == "asistente"): ?> selected <?php endif ?>>Asistente</option>
