												...
												<div class="card-body">
													...
													<div class="form-group">
														...
														<div class="d-flex justify-content-between">
															...
															<label for="info_product">Item <?php echo ($key+1) ?><sup class="text-danger">*</sup></label>

															<?php if (($key+1) == 1): ?>

																<div>
																	<button type="button" class="btn btn-default btn-sm rounded-pill px-3 addVariant"><i class="fas fa-plus fa-xs"></i> Agregar nuevo Item</button>
																</div>

															<?php else: ?>

																<div>
																	<button type="button" class="btn btn-default btn-sm rounded-pill px-3 deleteVariant" idVariant="<?php echo base64_encode($value->id_variant) ?>"><i class="fas fa-times fa-xs"></i> Quitar Item</button>
																</div>
									...
									<?php else: ?>
										...
										<div class="form-group">
											...
											<div class="d-flex justify-content-between">
												...
												<label for="info_product">Item 1<sup class="text-danger">*</sup></label>

												<div>
													<button type="button" class="btn btn-default btn-sm rounded-pill px-3 addVariant">
														<i class="fas fa-plus fa-xs"></i> Agregar nuevo Item
													</button>
												</div>
