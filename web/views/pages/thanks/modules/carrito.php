	...
	<?php if (!empty($carts)): $totalCart = 0; ?>
				...
				<?php endif ?>
				 ...
				 <div class="row" style="position:relative;">
		            ...
		            <div class="col-12 col-lg-8 text-left">
		              ...
		              <div class="media">
		                  ...
		                  <figure class="imgProduct">
							...
							<?php else: 
								$arrayYT = explode("/", $value->media_variant);
								$stringYT = end($arrayYT);
								$lastarrayYT = explode("?", $stringYT)
						    ?>

		                        <img src="http://img.youtube.com/vi/<?php echo reset($lastarrayYT) ?>/maxresdefault.jpg" class="img-thumbnail mr-3" style="width:80px">
		            ...
		            <div class="col-6 col-lg-4 text-center mt-3">
		              ...
		              S/<span class="subtotalCart_<?php echo $key ?> subtotalCart">
	    ...
	    <div class="card-footer bg-light">
	        ...
	        <div class="row">
	            ...
	            <div class="col-3 col-lg-8 text-right font-weight-bold">TOTAL EN SOLES:</div>
	            <div class="col-3 col-lg-4 text-center font-weight-bold">
	              S/ <span class="totalCart"><?php echo number_format($totalCart,2)  ?></span>
	            </div>
			...
			<div class="row">
			  ...
			  <div class="col-3 col-lg-8 text-right font-weight-bold">TOTAL EN DOLARES:</div>
			  <div class="col-3 col-lg-4 text-center font-weight-bold">
				$ <span class="totalCart"><?php echo number_format(round($totalCart/TemplateController::exchange("currency")),2)  ?></span>
			  </div>
