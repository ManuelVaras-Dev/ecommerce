...
function validateJS(event, type){
  ...
  if(type == "password"){
    ...
    if(!pattern.test(event.target.value)){
      ...
      $(event.target).parent().children(".invalid-feedback").html("La contraseña no puede llevar espacios ni otros caracteres especiales");
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <div class="d-flex justify-content-between">
              ...
              <label for="info_product">Item ${variantItem}<sup class="text-danger">*</sup></label>

              <div>
                <button type="button" class="btn btn-default btn-sm rounded-pill px-3 quitVariant"><i class="fas fa-times fa-xs"></i> Quitar Item</button>
              </div>
    ...
    $.ajax({
        ...
        success: function (response){  
          ...
          if(response == 200){
            ...
            fncToastr("success","Item borrado correctamente");
          }
