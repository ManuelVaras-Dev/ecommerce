...
$(document).on("click",".deleteItem", function(){
  ...
  fncSweetAlert("confirm","¿Está seguro de eliminar este registro?","").then(resp=>{
        ...
        success: function (response){
          ...
          if(response == 200){
            ...
            if(table == "categories"){
              ...
              fncMatPreloader("off");
              fncToastr("warning","Este registro no se puede borrar porque tiene subcategorías vinculadas");
            
            }else if(table == "subcategories"){

              fncMatPreloader("off");
              fncToastr("warning","Este registro no se puede borrar porque tiene productos vinculados");
            
            }else{
               
              fncMatPreloader("off");
              fncToastr("warning","No es posible borrar este registro");
            ...
            fncMatPreloader("off");
            fncToastr("error","Se presentó un error inesperado al intentar eliminar el registro");
          ...
          $.ajax({
            ...
            success: function (response){
             ...
             if(response == 200){
                ...
                fncToastr(
                  "success",
                  "Estado del registro actualizado correctamente"
                  )

              }else{

                fncMatPreloader("off");
                fncToastr("Error","El estado de registro no se pudo actualizar");
